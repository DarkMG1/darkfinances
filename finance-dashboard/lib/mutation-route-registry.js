...
const MUTATION_ROUTES = Object.freeze([
  ...
  route('DELETE', '/transactions/:id', C.MULTIPLE_INTERNAL_WRITES, 'api.deleteTransaction before transaction-reference sidecar rewrites', 'after_local'),
  ...
  route('POST', '/phantom/cleanup', C.MULTIPLE_INTERNAL_WRITES, 'first matching api.deleteTransaction; dry-run has no write', 'after_local'),
  ...
  route('POST', '/rules', C.MULTIPLE_INTERNAL_WRITES, 'first matching api.updateTransaction, or rules sidecar write when no match', 'after_local_if_changed'),
  route('POST', '/rules/apply', C.MULTIPLE_INTERNAL_WRITES, 'first matching api.updateTransaction across rule/catalog stages', 'after_local_if_changed'),
